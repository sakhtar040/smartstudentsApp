...
var SchoolRegisterPage = /** @class */ (function () {
    function SchoolRegisterPage(navCtrl, navParams, authPro, alertCtrl) {
    ...
    SchoolRegisterPage.prototype.state_reg = function () {
        var _this = this;
        this.authPro.state('state').then(function (data) {
            _this.state_data = data;
        });
    };
    SchoolRegisterPage.prototype.courses = function () {
        var _this = this;
        this.authPro.all_courses('all_courses').then(function (data) {
            _this.courses_data = data;
        });
    };
    SchoolRegisterPage.prototype.sch_register = function () {
        var _this = this;
...
export { SchoolRegisterPage };
//# sourceMappingURL=school-register.js.map