...
var ForGovtPage = /** @class */ (function () {
    function ForGovtPage(navCtrl, navParams, modalCtrl, authPro) {
    ...
    ForGovtPage.prototype.openModal = function () {
        var modal = this.modalCtrl.create(LoginPage);
        modal.present();
    };
    ForGovtPage.prototype.school = function () {
        this.navCtrl.push(SchoolPage);
    };
    ForGovtPage.prototype.coaching = function () {
        this.navCtrl.push(CoachingPage);
    };
    ForGovtPage.prototype.college = function () {
        this.navCtrl.push(CollegePage);
    };
    ForGovtPage.prototype.counselling = function () {
        this.navCtrl.push(CounsellingPage);
    };
    ForGovtPage.prototype.exams = function () {
        this.navCtrl.setRoot(ExamPage);
    };
    ForGovtPage.prototype.studyabroad = function () {
        this.navCtrl.push(StudyabroadPage);
    };
    ForGovtPage.prototype.loan = function () {
        this.navCtrl.push(EducationloanPage);
    };
    ForGovtPage.prototype.contact_form = function () {
        var _this = this;
    ...
    ForGovtPage = __decorate([
        IonicPage(),
        Component({
            selector: 'page-for-govt',
            templateUrl: 'for-govt.html',
        }),
...
export { ForGovtPage };
//# sourceMappingURL=for-govt.js.map