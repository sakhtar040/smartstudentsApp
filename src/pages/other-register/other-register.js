...
var OtherRegisterPage = /** @class */ (function () {
    function OtherRegisterPage(navCtrl, navParams, authPro, alertCtrl) {
    ...
    OtherRegisterPage = __decorate([
        IonicPage(),
        Component({
            selector: 'page-other-register',
            templateUrl: 'other-register.html',
        }),
        __metadata("design:paramtypes", [NavController, NavParams, AuthProvider, AlertController])
    ], OtherRegisterPage);
    return OtherRegisterPage;
}());
export { OtherRegisterPage };
//# sourceMappingURL=other-register.js.map