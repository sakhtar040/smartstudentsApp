...
var CoachingRegisterPage = /** @class */ (function () {
    function CoachingRegisterPage(navCtrl, navParams, authPro, alertCtrl) {
    ...
    CoachingRegisterPage.prototype.state_reg = function () {
        var _this = this;
        this.authPro.state('state').then(function (data) {
            _this.state_data = data;
        });
    };
    CoachingRegisterPage.prototype.onSelect = function () {
        console.log(this.orgData.org_course);
    };
    CoachingRegisterPage.prototype.courses = function () {
        var _this = this;
        this.authPro.all_courses('all_courses').then(function (data) {
            _this.courses_data = data;
        });
    };
    CoachingRegisterPage.prototype.sch_register = function () {
        var _this = this;
    ...
    CoachingRegisterPage = __decorate([
        IonicPage(),
        Component({
    ...
    ], CoachingRegisterPage);
    return CoachingRegisterPage;
}());
export { CoachingRegisterPage };
//# sourceMappingURL=coaching-register.js.map